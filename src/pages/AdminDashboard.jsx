  ...
  return (
    <div className="admin-dashboard-page">
      ...
      <div className="dashboard-content">
        {/* Sidebar - Updated to match screenshot */}
        ...
        {/* Main Content - Updated to match screenshot */}
        <main className="dashboard-main">
          ...
          {activeTab === 'manage' && (
            <div className="dashboard-section">
              ...
              <p className="section-description">View and manage registered tourists</p>
              <div className="empty-state">
                <p>Tourist management features will be available here</p>
              </div>
            </div>
          )}
          ...
          {activeTab === 'alerts' && (
            <div className="dashboard-section">
              ...
              <p className="section-description">View and respond to emergency alerts</p>
              <div className="empty-state">
                <p>Emergency alerts will be displayed here</p>
              </div>
            </div>
          )}
          ...
          {activeTab === 'reports' && (
            <div className="dashboard-section">
              <h2>Reports</h2>
              <p className="section-description">Generate and view reports</p>
              <div className="empty-state">
          ...
          {activeTab === 'settings' && (
            <div className="dashboard-section">
              <h2>Settings</h2>
              <p className="section-description">Configure your dashboard settings</p>
              <div className="empty-state">
